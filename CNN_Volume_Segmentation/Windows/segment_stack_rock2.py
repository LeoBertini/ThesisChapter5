...
model_dir = "E:\\CoralReefRock2\\MODELS\\model-20240509-002933.pth"
device = torch.device('cuda')
model = create_model(params)
model.load_state_dict(torch.load(model_dir, map_location=device))

# TODO import fullsized image stack
stack_dir = "E:\\Leo_ReefRock2_DATA_ANALYSES\\LB_0045_BH\\TIFF_VerticalAxis"
out_dir =  "E:\\Leo_ReefRock2_DATA_ANALYSES\\LB_0045_BH\\PREDICTIONS_VERTICAL"
