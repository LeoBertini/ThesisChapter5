...
model_dir = "E:\\CoralThinWorms\\MODELS\\model-20240522-223012.pth"
device = torch.device('cuda')
model = create_model(params)
model.load_state_dict(torch.load(model_dir, map_location=device))

# TODO import fullsized image stack
stack_dir = "E:\\Leo_ThinWorms_DATA_ANALYSES\\LB_0031_BH\\TIFF_HorizontalAxis"
out_dir =  "E:\\Leo_ThinWorms_DATA_ANALYSES\\LB_0031_BH\\PREDICTIONS"
