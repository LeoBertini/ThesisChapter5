...
model_dir = "E:\\CoralReefRockSponge\\MODELS\\model-20240531-215137.pth"
device = torch.device('cuda')
model = create_model(params)
model.load_state_dict(torch.load(model_dir, map_location=device))

# TODO import fullsized image stack
stack_dir = "E:\\Leo_Sponge_DATA_ANALYSES\\LB_0034_BH\\TIFF_HorizontalAxis"
out_dir =  "E:\\Leo_Sponge_DATA_ANALYSES\\LB_0034_BH\\PREDICTIONS_ReefRock"
