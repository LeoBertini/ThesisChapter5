...
model_dir = "E:\CoralSHELL\MODELS\model-20240507-175222.pth"
device = torch.device('cuda')
model = create_model(params)
model.load_state_dict(torch.load(model_dir, map_location=device))

# TODO import fullsized image stack
stack_dir = "E:\\Leo_Shell_DATA_ANALYSES\\LB_0008_BH\\TIFF_VerticalAxis"
out_dir =  "E:\\Leo_Shell_DATA_ANALYSES\\LB_0008_BH\\PREDICTIONS_VERTICAL"
