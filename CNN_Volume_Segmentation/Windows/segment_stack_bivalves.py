...
model_dir = "E:\\CoralBIVALVES\\MODELS\\model-GREY_E20.pth"
device = torch.device('cuda')
model = create_model(params)
model.load_state_dict(torch.load(model_dir, map_location=device))

# TODO import fullsized image stack
stack_dir = "E:\\Leo_Bivalves_DATA_ANALYSES\\LB_0008_BH\\TIFF_HorizontalAxis"
out_dir =  "E:\\Leo_Bivalves_DATA_ANALYSES\\LB_0008_BH\\PREDICTIONS"
